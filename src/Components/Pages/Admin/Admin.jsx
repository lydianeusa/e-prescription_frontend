      ...
      <div>
        ...
        <main className="admin">
          <div>
            ...
            <Link to="/patient/:id/update"><button className="btn-3">Modifier patient</button></Link>
          </div>
          ...
          <div>
            ...
            <Link to="/pharmacy/:id/update"><button className="btn-4">Modifier une pharmacie</button></Link>
          </div>
          <div>
            <h2>Médecin</h2>
            <Link to="/physicianslist"><button className="btn-3">Liste médecins</button></Link>
            <Link to="/find-physican"><button className="btn-3">Trouver un médecin</button></Link>
            <Link to="/create-physician"><button className="btn-3">Créer un médecin</button></Link>
            <Link to="/physician/:id/update"><button className="btn-3">Modifier un médecin</button></Link>
          </div>
          <div>
            <h2>Ordonnance</h2>
            ...
            <Link to="/prescription/:id/update"><button className="btn-4">Modifier ordonnance</button></Link>
