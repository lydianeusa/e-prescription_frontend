...
//                 </>
//                 ) : (
//                 <p className="prescriptionDetail">Pas d'ordonannce trouvée</p>
//                 )}
//                 </main>
//                 <Footer/>
//             </div>
...
const PrescriptionDetail = () => {
  ...
  console.log("Prescription passed in location state:", prescription); 
  ...
  return (
    <div>
      <Header />
      <main className="prescriptionDetail">
        {prescription ? (
          <>
            <h1>Détail de l'ordonnance</h1>
            <div>
              ...
              {isAuthorizedUser && (
                <>
                  <button className="btn-4">
                    <Link to={`/prescription/${prescription.id}/update`}>Modifier l'ordonnance</Link>
                  </button>
                  {/* <button className="btn-3" onClick={() => handleDeleteClick(prescription)}>Supprimer l'ordonnance</button> */}
                </>
              )}
